                            ...
                            <div class="form-group">
                                ...
                                {{-- <div class="col-sm-10 mb-3"> --}}
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="provider_image" name="provider_image" readonly value="{{ $provider->image }}">
                                    ...
                                    <br>
                                    <img src="{{ asset($provider->image) }}" alt="{{ $provider->slug }}" class="img-fluid provider-img" width="150px" height="150px">
                                {{-- </div> --}}
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="publish" name="publish" value="1" {{ $provider->publish ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="publish">Có</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="unpublish" name="publish" value="0" {{ !$provider->publish ? 'checked' : '' }}>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_title" placeholder="Nhập tiêu đề dùng trong seo." value="{{ $provider->meta_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Meta keyword: </label>
                                    <input type="text" class="form-control" name="meta_keyword" placeholder="Nhập từ khóa dùng trong seo." value="{{ $provider->meta_keyword }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Meta description: </label>
                                    <textarea name="meta_desc" id="" cols="30" rows="4" class="form-control" placeholder="Nhập mô tả dùng trong seo.">{{ $provider->meta_desc }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
