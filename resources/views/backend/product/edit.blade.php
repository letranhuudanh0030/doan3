                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control price" name="price" value="{{ $product->price }}">
                                <span class="text-primary">Nhập đơn giá sản phẩm. Nếu không nhập mặc định là 0 (liên hệ)</span>
                                <input type="text" class="form-control format-price" value="0" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="" class="form-control">
                                    ...
                                    {{ showCategories($categories, $product) }}
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="image" name="image" readonly value="{{ $product->image }}">
                                ...
                                <br>
                                <img src="{{ $product->image }}" alt="" class="img-fluid product-img" width="150px" height="150px">
                            </div>

                            <div class="form-group">
                                <label class="form-control-label">Thêm nhiều hình ảnh: </label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="images" name="images" readonly value="{{ $product->images }}">
                                    <div class="input-group-append">
                                ...
                                @if ($product->images)
                                    ...
                                    @foreach (explode(',', $product->images) as $item)
                                        <img src="{{ asset($item) }}" alt="" class="img-fluid product-imgs" width="150px" height="150px">
                                    @endforeach
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_desc" id="short-desc" cols="30" rows="5" class="form-control">{{ $product->short_desc }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Mô tả: </label>
                                <textarea name="desc" id="desc" cols="30" rows="5" class="form-control">{{ $product->desc }}</textarea>
                            </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="publish" name="publish" value="1" {{ $product->publish ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="publish">Có</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="unpublish" name="publish" value="0" {{ !$product->publish ? 'checked' : '' }}>
                                ...
                                <div class="custom-control custom-radio custom-control-inline mt-2">
                                    <input type="radio" class="custom-control-input" id="highlight" name="highlight" value="1" {{ $product->highlight ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="highlight">Có</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="unhighlight" name="highlight" value="0" {{ !$product->highlight ? 'checked' : '' }}>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_title" placeholder="Nhập tiêu đề dùng trong seo." value="{{ $product->meta_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Meta keyword: </label>
                                    <input type="text" class="form-control" name="meta_keyword" placeholder="Nhập từ khóa dùng trong seo." value="{{ $product->meta_keyword }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Meta description: </label>
                                    <textarea name="meta_desc" id="" cols="30" rows="4" class="form-control" placeholder="Nhập mô tả dùng trong seo.">{{ $product->meta_desc }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
